...
[**Open the google.com  (Link test)**](http://www.google.com)<br>
[**Google Sayfasını aç (Link testi)**](http://www.google.com)
<br>
<br>
...
In this line ~~I will strike out some words~~<br>
Bu satırda ~~Bazı kelimelerin üstünü çizeceğim.~~
...
## Tables - Tablolar
First Header | İkinci Başlık
-------------| ------------
Content from cell 1| İkinci Hücreden içerik
Content in the first column | İkinci Sütundan içerik
<br>
<br>
